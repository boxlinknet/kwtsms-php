...
Input: array of phone numbers + message
  ...
  │       ├─ Reject invalid numbers locally to $result['invalid']
  ...
  │           Returns merged result with msg-ids array and batches count
  │
  End
```
...
// $bulk['result']           'OK', 'ERROR', or 'PARTIAL'
...
// $bulk['errors']           batch-level errors (code and description per batch)
```
